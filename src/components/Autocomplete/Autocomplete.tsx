...
export function Autocomplete({selectedFunction}: { selectedFunction: (item: any) => void}) {
  ...
  return (
    <div
      className="relative cursor-default rounded-full text-left  sm:text-sm relative" {...autocomplete.getRootProps({})}
      ref={formRef}
    >
